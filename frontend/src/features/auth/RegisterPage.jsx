  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (
        ...
        setError(submitError.message || "Could not create your passkey account.");
      } else if (submitError instanceof Error) {
        setError(submitError.message || "Could not create your passkey account.");
      } else {
        setError("Could not create your passkey account.");
      }
    } finally {
  ...
  return (
    <div className="space-y-4">
      <header className="space-y-1 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white">Create account with passkey</h1>
        <p className="text-sm text-slate-400">
          Use your device passkey for passwordless sign-in. Email recovery stays available as backup.
        </p>
      </header>
